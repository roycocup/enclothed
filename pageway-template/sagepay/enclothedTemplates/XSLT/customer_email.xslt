...
<xsl:output method="xhtml" encoding="ISO-8859-1" indent="yes" omit-xml-declaration="yes" media-type="text/html" 
 doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"/>
	...
	<xsl:template match="/payment-model">
		...
		<div id="pageWrapper">
		    <div id="headerTop">
				<img src="{concat(imagesURL,vendor/vendortemplate,'/logo-black.gif')}" id="customLogo" />
	        </div>
	        <div class="midHeader">
	        	<span>Payment</span>
				<img src="{concat(imagesURL,vendor/vendortemplate,'/line.gif')}" id="payment" />
	        </div>
	        <div class="contentWrapper">
        	<div class="innerContentWrapper">	
				    <div id="header">
		            <table id="transactionHeaderTable" border="0" cellpadding="0" cellspacing="0">
		                <tbody>
		                    <tr>
		                        <td valign="top">
