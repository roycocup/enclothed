            ...
            <form method="post" name="carddetails" id="carddetails">
                ...
                <table class="formTable">
                    ...
                    <xsl:if test="$usingtoken != 'true' and $transactiontypeid != 15">
	                    ...
	                    <xsl:if test="$vpsprotocol &lt; 2.23">
	                    <tr>
	                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='billing_address']"/><span class="errortext">*</span></td>
	                        <td class="data" colspan="2"><textarea name="cardaddress" cols="25" rows="4"><xsl:value-of select="payment-model/transaction/billingaddress"/></textarea></td>
	                    </tr>
	                    <tr>
	                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='billing_postcode']"/><span class="errortext">*</span></td>
	                        <td class="data" colspan="2"><input size="5" maxlength="10" name="cardpostcode" value="" style="width: 70px;"><xsl:attribute name="value"><xsl:value-of select="payment-model/transaction/billingpostcode"/></xsl:attribute></input></td>
	                    </tr>
	                    </xsl:if>
	                    <xsl:if test="$vpsprotocol &gt; 2.22">
	                    <tr>
	                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='billing_address1']"/><span class="errortext">*</span></td>
	                        <td class="data" colspan="2"><input size="30" maxlength="100" name="cardaddress" autocomplete="off" value=""><xsl:attribute name="value"><xsl:value-of select="payment-model/transaction/billingaddress"/></xsl:attribute></input></td>
	                    </tr>
	                    <tr>
	                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='billing_address2']"/><span class="errortext"></span></td>
	                        <td class="data" colspan="2"><input size="30" maxlength="100" name="cardaddress2" autocomplete="off" value=""><xsl:attribute name="value"><xsl:value-of select="payment-model/transaction/billingaddress2"/></xsl:attribute></input></td>
	                    </tr>																
	                    <tr>
	                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='billingcity']"/><span class="errortext">*</span></td>
	                        <td class="data" colspan="2"><input size="30" maxlength="40" name="cardcity" autocomplete="off" value=""><xsl:attribute name="value"><xsl:value-of select="payment-model/transaction/billingcity"/></xsl:attribute></input></td>
	                    </tr>
	                    <tr id="stateRow" style="display:none;">
	                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='billingstate']"/><span class="errortext">*</span></td>
	                        <td class="data" colspan="2">													
	                    ...
	                    <tr>
	                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='billingcountry']"/><span class="errortext">*</span></td>
	                        <td class="data" colspan="2">										
	                    ...
	                    <tr>
	                        <td class="label"><xsl:value-of select="$i18n/multi-lingual-text/texts[lang($lang)]/text[@label='billing_postcode']"/><span class="errortext">*</span></td>
	                        <td class="data" colspan="2"><input size="5" maxlength="10" name="cardpostcode" value="" style="height: 22px; width: 70px;"><xsl:attribute name="value"><xsl:value-of select="payment-model/transaction/billingpostcode"/></xsl:attribute></input></td>
	                    </tr>
	                    </xsl:if>
                    </xsl:if>
