...
class SwiftPageBuilderShortcode_spb_icon_box extends SwiftPageBuilderShortcode {
    ...
    public function content( $atts, $content = null ) {
        ...
        $image_url = $image_object[0];
       	...
       	$icon_box_output = do_shortcode('[sf_iconbox character="'.$character.'" image="'.$image.'" color="standard" type="'.$box_type.'" title="'.$title.'" animation="'.$animation.'" animation_delay="'.$animation_delay.'" color="'.$color.'"]'.$content.'[/sf_iconbox]');
