...
$args = array(
    "label" 						=> _x('Gallery Categories', 'category label', "swift-framework-admin"), 
    "singular_label" 				=> _x('Gallery Category', 'category singular label', "swift-framework-admin"), 
    'public'                        => true,
    'hierarchical'                  => true,
    'show_ui'                       => true,
...
function galleries_register() {
    ...
    $labels = array(
        'name' => _x('Galleries', 'post type general name', "swift-framework-admin"),
        'singular_name' => _x('Gallery', 'post type singular name', "swift-framework-admin"),
        'add_new' => _x('Add New', 'gallery', "swift-framework-admin"),
