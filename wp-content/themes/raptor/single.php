												...
												<div <?php post_class('actual_post') ?> id="post-<?php the_ID(); ?>">
													<div class="ta_meta_container">
                                                        ...
                                                        <div class="featured_section_sheader">                            
                                                                <?php the_post_thumbnail( 'Raptorsingle' ); ?>
                                                        </div>              
                                                        <?php endif; ?>   
                                                        ...
                                                        <div class="actual_post_author">
                                                            <div class="actual_post_posted"><?php _e('Posted by :','Raptor'); ?><span><?php the_author() ?></span> <?php _e('On :','Raptor'); ?> <span><?php the_time(get_option( 'date_format' )) ?></span></div>
                                                        ...
                                                        <div class="metadata">
                                                            <p>
                                                                <span class="label"><?php _e('Category:', 'Raptor') ?></span>
                                                                <span class="text"><?php the_category(', ') ?></span>
                                                            </p>
                                                            <?php the_tags('<p><span class="label">'.__('Tags:','Raptor').'</span><span class="text">', ', ', '</span></p>'); ?>
													...
													<div class="post_entry">
														...
														<div class="entry">
															<?php the_content(__('<span>Continue Reading >></span>', 'Raptor')); ?>
															<div class="clear"></div>
															<?php wp_link_pages( array( 'before' => '<div class="page-link"><span>' . __( 'Pages:', 'Raptor' ) . '</span>', 'after' => '</div>' ) ); ?>	
                                                          	<?php 
																
																if (is_attachment()){ 
																	echo '<p class="Raptor_prev_img_attch">';
																	previous_image_link( false, '&#171; '.__('Previous Image' , 'Raptor').'' ); 
																	echo '</p>';
																}  
															?> 
                                                          	<?php 
																...
																if (is_attachment()){ 
																	echo '<p class="Raptor_prev_img_attch">';
																	next_image_link( false, ''.__('Next Image' , 'Raptor').' &#187;' );
																	echo '</p>'; 
																}
															?>                                                                                                                        																			
														</div>
                                                    ...
                                                    <div class="post_author_bio">
                                                        ...
                                                        <div class="post_author_bio_social">
                                                            	...
                                                            	<?php 
																	$authorswebsitelink =  Raptor_get_custom_field('authors_website', get_the_ID(), true);
                                                                ...
                                                                <div class="authors_website">
                                                                	...
                                                                	<p><a href="<?php echo $authorswebsite; ?>"><?php _e("Visit Author's Website",'Raptor'); ?></a></p>
                                                            	</div>
                                                                <?php endif; ?>
                                                            
                                                        	
                                                            	<?php 
																	$authorstwitterlink =  Raptor_get_custom_field('authors_twitter', get_the_ID(), true);
                                                                ...
                                                                <div class="authors_twitter">                                                           
                                                            		<p><a href="https://www.twitter.com/<?php echo $authorstwitter; ?>"><?php _e("Follow On Twitter",'Raptor'); ?></a></p>
                                                            	</div>  
                                                            	<?php endif; ?>
                                                            	...
                                                            	<?php 
																	$authorsfacebooklink =  Raptor_get_custom_field('authors_facebook', get_the_ID(), true);
                                                                ...
                                                                <div class="authors_facebook">                                                           
                                                            		<p><a href="<?php echo $authorsfacebook; ?>"><?php _e("Like On Facebook",'Raptor'); ?></a></p>
                                                            	</div>
																<?php endif; ?>                                                                                                                      
                                                    ...
                                                    <div class="single_newsletter">
                                                    	...
                                                    	<div class="single_newsletter_heading">
                                                        	<p><a href="<?php echo get_feed_link( 'rss2' ); ?>"><?php _e('Subscribe To RSS','Raptor'); ?></a></p>
                                                        </div>                                                     
                                                    ...
                                                    <div class="single_np">
                                                          	...
                                                          	<?php 
																...
																previous_post_link('<div class="single_np_prev"><p class="single_np_prev_np">'.__('Previous Post' , 'Raptor').'</p><p> %link</p></div>');
															...
															?>                                                            
                                                          	...
                                                          	<?php 
																...
																next_post_link('<div class="single_np_next"><p class="single_np_next_np">'.__('Next Post' , 'Raptor').'</span></p><p> %link</p></div>');
