			<?php get_header(); ?>
                    ...
                    <div id="inner_content_section">
                        ...
                        <div id="main_content_section_search_title"> 
                        	...
                        	<div class="mag_post">
                        		<h2 class="main_content_section_search_title"><?php _e('Search Results for : ', 'Raptor') ?><?php echo get_search_query(); ?></h2>
                            </div>
                        ...
                        <div id="main_content_section_search">
                                   ...
                                   <?php if (have_posts()) : ?>
									<?php $count = 0; while (have_posts()) : the_post(); $count++; ?>									
										<div <?php post_class('mag_post') ?> id="post-<?php the_ID(); ?>">
											...
											<div class="mag_post_excerpt">
												...
												<img src="<?php echo $magthumb[0]; ?>" alt="<?php echo Raptor_get_limited_string(get_the_title(), 40, '...') ?>" />
												</div>
												<?php endif; ?>
									...
									<?php endwhile; ?>
												...
												<?php else : ?>
													<div class="nopost">
														<p><?php _e('Sorry, No Results Found.', 'Raptor') ?></p>
													 </div><!-- /nopost -->
												<?php endif; ?>
