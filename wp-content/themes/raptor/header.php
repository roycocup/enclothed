            ...
            <div id="header_social_cont">
            	...
            	<div id="header_social">
                	...
                	<div class="header_rss">
                    	...
                    	<p><a href="<?php bloginfo('rss2_url'); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/skins/images/rss.png" width="35" height="35" border="0" alt="Rss" /></a></p>
			...
			<div id="wrapper_three">
                ...
                <div id="content_section">
                    ...
                    <!-- Menu Section starts here -->
            			...
            			<div id="menu">
							<?php wp_nav_menu( array( 'theme_location' => 'mainmenu', 'menu_class' => 'dropdown dropdown-horizontal','fallback_cb'     => 'Raptor_backupmenu', 'menu_id'=>'Main_nav', 'container'=>'') ); ?>			
                        </div>
