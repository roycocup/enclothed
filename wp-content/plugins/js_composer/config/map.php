...
vc_map( array(
  ...
  "params" => array(
    array(
      ...
      "param_name" => "color",
      "value" => array(__('Informational', "js_composer") => "alert-info", __('Warning', "js_composer") => "alert-warning", __('Success', "js_composer") => "alert-success", __('Error', "js_composer") => "alert-danger"),
